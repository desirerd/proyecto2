                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Solicitud de Cita en Clinic<span style="color: #5caad2;"></span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            Gracias por solicitar una cita a través de nuestra web. Nos pondremos en contacto con usted lo antes posible.
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Los datos recibidos an sido los siguientes:<br>
                                            <b> Nombre y Apellidos : </b>{{ $name }},
                                           	{{$apellidos}}<br>
											<b>Email:</b> {{$email}}<br>
											<b>Tlf:</b> {{$telefono}}<br>
											<b>Doctor con el que desea pedir cita </b>: {{$invisible}} , {{$invisible2}}
											<br><br>
											Si estos datos no son correctos, porfavor póngase en contacto con nosotros en +34756985
											o en dudasdelsistema@jfalksdfj.com
                                            ...
                                            <tr>
                                                <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                                    ...
                                                    <div style="line-height: 26px">
                                                        ...
                                                        Clinic - Tu sistema de gestión de citas médicas
